...
if __name__ == '__main__':
    for baseline in ['rted', 'pdiff']:
        for setting in ["within-apps", "across-apps"]:
            ...
            filename = f'{base_path}/results/rq2/rq2-ALT-{setting}-{baseline}.csv'
            if OUTPUT_CSV:
            ...
            for app in APPS:
                ...
                pred_file = f'{base_path}/resources/csv_results_table/SS_as_distance_matrix_{setting}-{app}-{baseline}.csv'
